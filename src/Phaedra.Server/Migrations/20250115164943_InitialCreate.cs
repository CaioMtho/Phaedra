    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TextStyles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "integer", nullable: false),
                    TextStyleId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TextSegments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TextSegments_ContentBlocks_ContentBlockId",
                        column: x => x.ContentBlockId,
                        principalTable: "ContentBlocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TextSegments_TextStyles_TextStyleId",
                        column: x => x.TextStyleId,
                        principalTable: "TextStyles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TextSegments_ContentBlockId",
                table: "TextSegments",
                column: "ContentBlockId");

            migrationBuilder.CreateIndex(
                name: "IX_TextSegments_TextStyleId",
                table: "TextSegments",
                column: "TextStyleId");
